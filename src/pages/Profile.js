...
function Profile() {
    ...
    //asynchrone functie
    //get request maken naar backend om profielgegevens of andere data op te halen
    //die informatie slaan er op in de state van de profielpagina
    // en ten slotte kunnen we die state gebruiken om de gegevens weer te geven in de HTML
