    ...
    return (
        <>
            ...
            <div className="achtergrondseries">
                ...
                {error &&
                    <p className="errormessage"> Held niet gevonden. Is de spelling goed? Is het een Marvelheld? </p>}
                    ...
                    <>
                        <article className="uitslag">
                            ...
                            <article className="portretje">
                                ...
                                <div>
                                    <h2>Beschrijving:</h2> <p
                                    className="description">{yourComicHero.data.results[0].description} </p>
                                </div>
                            </article>
                            <div className="aantalSeries">
                                <h3> {yourComicHero.data.results[0].name} komt voor
                                    in {yourComicHero.data.results[0].comics.available} comics.</h3>
                                <h3> {yourComicHero.data.results[0].name} komt voor
                                    in {yourComicHero.data.results[0].series.available} series: </h3>
                                <h3> {yourComicHero.data.results[0].name} komt voor
                                    in {yourComicHero.data.results[0].stories.available} stories: </h3>
                                <h3> {yourComicHero.data.results[0].name} komt in
                                    totaal {yourComicHero.data.results[0].stories.available + yourComicHero.data.results[0].series.available + yourComicHero.data.results[0].comics.available} keer
                                    voor: </h3>
                            </div>
