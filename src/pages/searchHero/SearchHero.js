                    ...
                    <div className="jouwheld">
                     <h1 className="naam">{yourFavoriteHero[0].name}</h1>
                        ...
                        <div className="heldgegevens">
                            ...
                            <p className="gegevens"> <p className="records">Kleur ogen: </p>{yourFavoriteHero[0].appearance.eyeColor.replaceAll("Blue", "Blauw").replaceAll("blue", "Blauw").replaceAll("Red", "Rood").replaceAll("Brown", "Bruin").replaceAll("White", "Wit").replaceAll("Purple", "Paars").replaceAll("Yellow", "Geel").replaceAll("Green", "Groen")}</p>
